...
namespace TugasBesar
{
    public class Akun
    {
        ...
        public String Update()
        {
            ...
            cmd.CommandText = "UPDATE akun set password = @password WHERE username = @username";
            cmd.Parameters.AddWithValue("@username", this.username);
        ...
        public String UbahUsername()
        {
            ...
            conn.Open();
            cmd = conn.CreateCommand();
            cmd.CommandText = "UPDATE akun set username = @usernamebaru WHERE username = @username";
            cmd.Parameters.AddWithValue("@username", this.username);
